  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const preloadResources = () => {
      return Promise.all([
        new Promise((resolve) => {
          ...
          link.rel = 'preload';
          link.href = 'https://cdn.jsdelivr.net/gh/2321881815/music1@main/txt(2025.11.30).txt';
          link.as = 'fetch';
    ...
    preloadResources().then(() => {
      // 加载文本内容
      fetch('https://cdn.jsdelivr.net/gh/2321881815/music1@main/txt(2025.11.30).txt')
        .then(response => {
